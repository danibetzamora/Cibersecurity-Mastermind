...
# Ejecutar código de un script:
   bash "Nombre Script"
   
  #Hay que declarar lo siguiente para que el script se ejecute con bash:
     "#!/bin/bash"
     Y después cambiar los permisos, dar permiso de ejecución al usuario y ejecutar con ./Nombre Archivo

  #Si queremos que el código python se ejecute con python3:
     "#!/bin/python3"
     Y dar permisos de ejecución al usuario

#Abrir directorio en VSCODE y Abrir Terminal:
     code "Nombre directorio" -> code /Scripts
     ctrl + ` -> Abre Terminal
